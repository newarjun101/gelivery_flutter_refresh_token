        ...
        return DefaultTabController(
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              actions: [
                GestureDetector(
                  onTap: () => viewModel.onLogout(context),
            ...
            viewModel.isLoading ? RefreshIndicator(
              onRefresh: () async {
              ...
              child: ListView.separated(
                ...
                padding:const EdgeInsets.symmetric(horizontal: kDefaultMarginWidth,
              ...
              onRefresh: () async{
                ...
                child: LazyLoadScrollView(
                    ...
                    child: PickupWidget(dataList: viewModel.deliAddressList,
